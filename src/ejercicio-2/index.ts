...
const facturaHTML = new HTML(150, "Empresa A", new Date(), "Cliente B", "Compra de productos en formato HTML");
const facturaPDF = new PDF(200, "Empresa X", new Date(), "Cliente Y", "Compra de servicios en formato PDF");
